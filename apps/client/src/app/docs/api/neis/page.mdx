...
```bash
# 특정 날짜 조회
curl -X GET "https://api.datagsm.com/api/neis/meals?date=2025-12-15" \
  -H "X-API-KEY: your-api-key-here"

# 기간 범위 조회
curl -X GET "https://api.datagsm.com/api/neis/meals?fromDate=2025-12-01&toDate=2025-12-31" \
  -H "X-API-KEY: your-api-key-here"
```
...
```bash
# 특정 날짜 조회
curl -X GET "https://api.datagsm.com/api/neis/schedules?date=2025-12-15" \
  -H "X-API-KEY: your-api-key-here"

# 기간 범위 조회
curl -X GET "https://api.datagsm.com/api/neis/schedules?fromDate=2025-12-01&toDate=2025-12-31" \
  -H "X-API-KEY: your-api-key-here"
```
...
| `429 Too Many Request` | 단위 시간에 너무 많은 요청량 발생 |
...
app.get('/meals', async (req, res) => {
  try {
    ...
    const response = await axios.get(`https://api.datagsm.com/api/neis/meals`, {
      headers: {
        'X-API-KEY': 'your-api-key-here',
      },
...
app.get('/schedules', async (req, res) => {
  try {
    const { date, fromDate, toDate } = req.query;
    const response = await axios.get(`https://api.datagsm.com/api/neis/schedules`, {
      headers: {
        'X-API-KEY': 'your-api-key-here',
      },
      params: { date, fromDate, toDate },
