...
|---------------------------|-------------|-----------------|---------------------------------------|-----------------------------------------------|
| **Java**                  | JDK 13+     | Gradle, Maven   | 타입 안전성, AutoCloseable, 빌더 패턴          | [Java SDK 문서](/docs/api/sdk/java)             |
| **Kotlin**                | 1.3.72+     | Gradle, Maven   | Java SDK와 완벽 호환, DSL 지원, Coroutine 통합 | [Java SDK 문서](/docs/api/sdk/java)             |
| **Python**                | 3.8+        | pip             | 타입 힌팅, 컨텍스트 매니저, async/await 지원       | [Python SDK 문서](/docs/api/sdk/python)         |
| **JavaScript/TypeScript** | Node.js 20+ | npm, yarn, pnpm | 완전한 TypeScript 지원, Promise 기반         | [JavaScript SDK 문서](/docs/api/sdk/javascript) |
...
2. **Python 사용자**: [Python SDK 문서](/docs/api/sdk/python)에서 설치, 설정, API 사용법을 확인하세요.
3. **JavaScript/TypeScript 사용자**: [JavaScript SDK 문서](/docs/api/sdk/javascript)에서 설치, 설정, API 사용법을 확인하세요.
