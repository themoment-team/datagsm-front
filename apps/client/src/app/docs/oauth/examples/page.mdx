  ...
  <div className="flex items-start gap-3">
    ...
    <div>
      ...
      <div className="text-yellow-800 dark:text-yellow-200 text-sm">
        새로운 애플리케이션에서는 <strong>PKCE</strong> 방식을 사용해주세요.
        일부 예제는 레거시 <code className="mx-1 px-1.5 py-0.5 bg-yellow-100 dark:bg-yellow-800 rounded">client_secret</code> 방식을 사용하고 있으며, PKCE로 마이그레이션을 권장합니다.
...
새로운 애플리케이션에서는 반드시 PKCE를 사용하세요. Authorization Code 탈취 공격을 효과적으로 방지합니다.
...
**⚠️ 새로운 프로젝트에서는 PKCE를 사용하여 client_secret을 아예 사용하지 마세요.**
