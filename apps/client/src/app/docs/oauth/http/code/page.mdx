  ...
  <div className="flex items-start gap-3">
    ...
    <div>
      ...
      <div className="text-blue-800 dark:text-blue-200 text-sm">
        보안 강화를 위해 <strong>PKCE (RFC 7636)</strong> 사용을 권장합니다.
        Authorization Code 요청 시 <code>code_challenge</code>와 <code>code_challenge_method</code>를 포함하고,
        Token 교환 시 원본 <code>code_verifier</code>를 제공하세요.
      </div>
    </div>
  </div>
</div>
...
| `code_challenge`        | `String` | 권장    | PKCE Code Verifier의 SHA-256 해시 (Base64URL 인코딩) | `E9Melhoa2OwvFrEMTJguCHaoeK1t8URWbuGJSstw-cM` |
| `code_challenge_method` | `String` | 권장    | Challenge 생성 방법 (`S256` 권장)                    | `S256`                                        |
