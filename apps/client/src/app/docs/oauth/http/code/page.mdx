  ...
  <div className="flex items-start gap-3">
    ...
    <div>
      ...
      <div className="text-yellow-800 dark:text-yellow-200 text-sm">
        보안을 위해 <code className="mx-1 px-1.5 py-0.5 bg-yellow-100 dark:bg-yellow-800 rounded">code_challenge</code> 및 <code className="mx-1 px-1.5 py-0.5 bg-yellow-100 dark:bg-yellow-800 rounded">code_challenge_method</code> 파라미터를 반드시 포함해주세요.
        PKCE를 사용하지 않는 방식은 레거시 지원용입니다.
...
| `code_challenge`        | `String` | 필수 (PKCE) | PKCE Code Verifier의 SHA-256 해시 (Base64URL 인코딩) | `E9Melhoa2OwvFrEMTJguCHaoeK1t8URWbuGJSstw-cM` |
| `code_challenge_method` | `String` | 필수 (PKCE) | Challenge 생성 방법 (항상 `S256` 사용)                    | `S256`                                        |
