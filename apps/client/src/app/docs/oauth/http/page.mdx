...
| `/v1/oauth/token` | `POST` | Refresh Token으로 새 Access Token 발급 (통합 엔드포인트) | [상세 문서](/docs/oauth/http/token-exchange-refresh) |
...
- [토큰 갱신](/docs/oauth/http/token-exchange-refresh) - Refresh Token으로 새 Access Token 발급
