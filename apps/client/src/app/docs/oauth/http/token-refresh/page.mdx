  ...
  <div className="flex items-start gap-3">
    ...
    <div>
      ...
      <div className="text-blue-800 dark:text-blue-200 text-sm">
        토큰 갱신 시 <code className="mx-1 px-1.5 py-0.5 bg-blue-100 dark:bg-blue-800 rounded">client_secret</code>는 필요하지 않습니다. <code className="mx-1 px-1.5 py-0.5 bg-blue-100 dark:bg-blue-800 rounded">refresh_token</code>만으로 갱신이 가능합니다.
      </div>
    </div>
  </div>
</div>
