...
// 인증 요청 시 포함
const authUrl = `https://oauth.data.hellogsm.kr/login?clientId=${clientId}&redirect_uri=${redirectUri}&state=${state}`;
...
- **GitHub 이슈**:
  - [DataGSM Front Issues](https://github.com/themoment-team/datagsm-front/issues)
  - [DataGSM Server Issues](https://github.com/themoment-team/datagsm-server/issues)
