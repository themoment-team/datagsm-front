...
export const ProfileInfo = ({ data }: ProfileInfoProps) => {
    ...
    return (
      <div className={cn('space-y-4')}>
        <div className={cn('border-2 border-foreground pixel-shadow')}>
          <div className={cn('border-b-2 border-foreground bg-foreground px-5 py-2.5')}>
            <span className={cn('text-xs font-mono uppercase tracking-widest text-background')}>PROFILE</span>
          </div>
  ...
  return (
    <div className={cn('space-y-4')}>
      ...
      {/* 학적 정보 */}
      <div className={cn('border-2 border-foreground')}>
        <div className={cn('flex items-center gap-2 border-b-2 border-foreground bg-foreground px-5 py-2.5')}>
          <GraduationCap className={cn('h-3.5 w-3.5 text-background')} />
          <span className={cn('text-xs font-mono uppercase tracking-widest text-background')}>학적 정보</span>
        </div>
      ...
      <div className={cn('border-2 border-foreground')}>
        <div className={cn('flex items-center gap-2 border-b-2 border-foreground bg-foreground px-5 py-2.5')}>
          <Home className={cn('h-3.5 w-3.5 text-background')} />
          <span className={cn('text-xs font-mono uppercase tracking-widest text-background')}>기숙사 및 동아리</span>
        </div>
      ...
      <div className={cn('border-2 border-foreground')}>
        <div className={cn('flex items-center gap-2 border-b-2 border-foreground bg-foreground px-5 py-2.5')}>
          <Shield className={cn('h-3.5 w-3.5 text-background')} />
          <span className={cn('text-xs font-mono uppercase tracking-widest text-background')}>계정 정보</span>
        </div>
        <div className={cn('grid grid-cols-2')}>
