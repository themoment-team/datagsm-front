...
| `leader`       | `ParticipantInfoDto \| null` | 동아리 부장 데이터. 부장이 없는 경우 `null`                         | -            |
...
| `studentNumber` | `Int \| null`   | 학번 (졸업/자퇴 등의 경우 null)                                         | `1201`             |
| `major`         | `Major \| null` | 학과 (졸업/자퇴 등의 경우 null, 값: `SW_DEVELOPMENT`, `SMART_IOT`, `AI`) | `SW_DEVELOPMENT`   |
