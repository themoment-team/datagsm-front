...
| `mealAllergyInfo` | `List<String>` | 알레르기 데이터 목록 (nullable)                 | `["1", "2", "5", "6"]`          |
| `mealCalories`    | `String`       | 칼로리 데이터 (nullable)                     | `650.8 Kcal`                    |
| `originInfo`      | `String`       | 원산지 데이터 (nullable)                     | `쌀:국내산 돼지고기:국내산 배추김치:국내산`       |
| `nutritionInfo`   | `String`       | 영양 데이터 (nullable)                      | `단백질:25.0g 지방:15.0g 탄수화물:90.0g` |
