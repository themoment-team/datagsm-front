...
**DataGSM OpenAPI SDK**는 DataGSM의 REST API를 더 쉽고 안전하게 사용할 수 있도록 설계된 공식 클라이언트 SDK입니다.
...
HttpRequest request = HttpRequest.newBuilder()
    .uri(URI.create("https://openapi.datagsm.kr/v1/neis/meals?date=2025-01-02"))
...
|---------------------------|-------------|-----------------|---------------------------------------|---------------------------------------------|
| **Java**                  | JDK 13+     | Gradle, Maven   | 타입 안전성, AutoCloseable, 빌더 패턴          | [Java SDK 기술 문서](/api/sdk/java)             |
| **Kotlin**                | 1.3.72+     | Gradle, Maven   | Java SDK와 완벽 호환, DSL 지원, Coroutine 통합 | [Java SDK 기술 문서](/api/sdk/java)             |
| **Python**                | 3.8+        | pip             | 타입 힌팅, 컨텍스트 매니저, async/await 지원       | [Python SDK 기술 문서](/api/sdk/python)         |
| **JavaScript/TypeScript** | Node.js 20+ | npm, yarn, pnpm | 완전한 TypeScript 지원, Promise 기반         | [JavaScript SDK 기술 문서](/api/sdk/javascript) |
| **.NET**                  | .NET 8.0+   | NuGet           | 타입 안전성, IDisposable, async/await 지원   | [.NET SDK 기술 문서](/api/sdk/dotnet)           |
| **Go**                    | Go 1.21+    | go get          | 타입 안전성, context 지원, 함수형 옵션 패턴        | [Go SDK 기술 문서](/api/sdk/go)                 |
  ...
  <div className="flex items-start gap-3">
    ...
    <div>
      <div className="font-semibold text-yellow-900 dark:text-yellow-100 mb-1">
        .NET SDK, Go SDK — 비공식 패키지
      </div>
      <div className="text-yellow-800 dark:text-yellow-200 text-sm">
        .NET SDK와 Go SDK는 공식 지원 패키지가 아닌 커뮤니티 기여 비공식 패키지입니다. 기능 및 업데이트 지원이 공식 SDK와 다를 수 있으므로 사용 시 유의하시기 바랍니다.
      </div>
    </div>
  </div>
</div>
...
| 기능              | 설명                             | 지원 API              |
|-----------------|--------------------------------|---------------------|
| **학생 데이터 조회**   | 재학생 데이터를 학년, 반, 번호, 학과 등으로 조회  | `client.students()` |
| **동아리 데이터 조회**  | 전공동아리, 창체동아리 데이터 조회            | `client.clubs()`    |
| **프로젝트 데이터 조회** | 학생들의 프로젝트 및 포트폴리오 데이터 조회       | `client.projects()` |
| **NEIS 데이터 조회** | 급식, 학사일정, 시간표 등 나이스 시스템 데이터 조회 | `client.neis()`     |
...
1. **Java/Kotlin 사용자**: [Java SDK 기술 문서](/api/sdk/java)에서 설치, 설정, API 사용법을 확인하세요.
2. **Python 사용자**: [Python SDK 기술 문서](/api/sdk/python)에서 설치, 설정, API 사용법을 확인하세요.
3. **JavaScript/TypeScript 사용자**: [JavaScript SDK 기술 문서](/api/sdk/javascript)에서 설치, 설정, API 사용법을 확인하세요.
4. **.NET 사용자**: [.NET SDK 기술 문서](/api/sdk/dotnet)에서 설치, 설정, API 사용법을 확인하세요.
5. **Go 사용자**: [Go SDK 기술 문서](/api/sdk/go)에서 설치, 설정, API 사용법을 확인하세요.

### 다음 단계

SDK를 설치하고 시작하려면:

1. 해당 언어의 SDK 기술 문서에서 **설치 가이드**를 따라 의존성을 추가하세요.
...
- **HTTP API 기술 문서**: SDK 없이 직접 REST API를 호출하려면 [HTTP API 기술 문서](/api/http)를 참고하세요.
- **GitHub 저장소**:
  - [Java SDK](https://github.com/themoment-team/datagsm-openapi-sdk-java)
  - [Python SDK](https://github.com/themoment-team/datagsm-openapi-sdk-python)
  - [JavaScript SDK](https://github.com/themoment-team/datagsm-openapi-sdk-javascript)
  - [.NET SDK](https://github.com/themoment-team/datagsm-openapi-sdk-dotnet)
  - [Go SDK](https://github.com/jihoonwjj/datagsm-openapi-sdk-go)
