  ...
  <div className="flex items-start gap-3">
    ...
    <div>
      ...
      <div className="text-amber-800 dark:text-amber-200 text-sm">
        현재 NEIS 시스템에 등록된 2025학년도 학사일정이 말소되었으며, 2026학년도 학사일정은 아직 등록되지 않은 상태입니다. 이에 따라 당분간 [학사일정 API](/docs/api/http/neis) 호출 시 실질적인 데이터가 반환되지 않을 수 있으니 서비스 이용에 참고하시기 바랍니다.
      </div>
    </div>
  </div>
</div>
