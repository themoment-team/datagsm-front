...
| --- | --- | --- | --- | --- | --- |
| [React + Spring Boot (BFF)](/docs/oauth/examples/react-spring-boot) | React | Spring Boot (Kotlin) | **PKCE** | BFF 패턴, 서버에서 OAuth 처리, httpOnly 쿠키 | 보안이 가장 중요한 프로덕션 환경 |
...
**권장 (PKCE 사용)**:
- [React + Spring Boot (BFF) 예제](/docs/oauth/examples/react-spring-boot)
