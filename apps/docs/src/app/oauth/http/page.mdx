...
```
https://oauth.authorization.datagsm.kr/v1/oauth/authorize?client_id=your-client-id&redirect_uri=https%3A%2F%2Fyour-app.com%2Fcallback&response_type=code&state=random-state-value
```
...
실전 예제를 보려면 [Examples 기술 문서](/oauth/examples)를 참고하세요.
